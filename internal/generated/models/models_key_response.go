...
// ModelsKeyResponse models key response
//
// swagger:model models.KeyResponse
type ModelsKeyResponse struct {
...
// Validate validates this models key response
func (m *ModelsKeyResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsKeyResponse) validateAlgorithm(formats strfmt.Registry) error {
...
func (m *ModelsKeyResponse) validateCurve(formats strfmt.Registry) error {
...
func (m *ModelsKeyResponse) validateProvider(formats strfmt.Registry) error {
...
// ContextValidate validate this models key response based on the context it is used
func (m *ModelsKeyResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsKeyResponse) contextValidateAlgorithm(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsKeyResponse) contextValidateCurve(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsKeyResponse) contextValidateProvider(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ModelsKeyResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ModelsKeyResponse) UnmarshalBinary(b []byte) error {
	var res ModelsKeyResponse
