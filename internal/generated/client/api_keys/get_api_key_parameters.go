...
// WithID adds the id to the get API key params
func (o *GetAPIKeyParams) WithID(id int64) *GetAPIKeyParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get API key params
func (o *GetAPIKeyParams) SetID(id int64) {
	o.ID = id
}
