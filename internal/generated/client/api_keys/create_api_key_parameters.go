...
type CreateAPIKeyParams struct {
	...
	*/
	Request *models.AuthCreateAPIKeyRequest
...
func (o *CreateAPIKeyParams) WithRequest(request *models.AuthCreateAPIKeyRequest) *CreateAPIKeyParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create API key params
func (o *CreateAPIKeyParams) SetRequest(request *models.AuthCreateAPIKeyRequest) {
	o.Request = request
}
