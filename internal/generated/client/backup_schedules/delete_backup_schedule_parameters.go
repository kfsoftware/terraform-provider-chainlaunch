...
// WithID adds the id to the delete backup schedule params
func (o *DeleteBackupScheduleParams) WithID(id int64) *DeleteBackupScheduleParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete backup schedule params
func (o *DeleteBackupScheduleParams) SetID(id int64) {
	o.ID = id
}
