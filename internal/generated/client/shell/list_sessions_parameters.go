...
// WithID adds the id to the list sessions params
func (o *ListSessionsParams) WithID(id int64) *ListSessionsParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the list sessions params
func (o *ListSessionsParams) SetID(id int64) {
	o.ID = id
}
