...
// WithID adds the id to the get config params
func (o *GetConfigParams) WithID(id int64) *GetConfigParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get config params
func (o *GetConfigParams) SetID(id int64) {
	o.ID = id
}
