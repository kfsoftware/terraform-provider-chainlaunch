...
type LoginUserParams struct {
	...
	/* Credentials.
	   ...
	   Login credentials
	*/
	Credentials *models.AuthLoginRequest
...
// WithCredentials adds the credentials to the login user params
func (o *LoginUserParams) WithCredentials(credentials *models.AuthLoginRequest) *LoginUserParams {
	o.SetCredentials(credentials)
	return o
}

// SetCredentials adds the credentials to the login user params
func (o *LoginUserParams) SetCredentials(credentials *models.AuthLoginRequest) {
