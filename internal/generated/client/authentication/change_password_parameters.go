...
func (o *ChangePasswordParams) WithRequest(request *models.AuthChangePasswordRequest) *ChangePasswordParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the change password params
func (o *ChangePasswordParams) SetRequest(request *models.AuthChangePasswordRequest) {
	o.Request = request
}
