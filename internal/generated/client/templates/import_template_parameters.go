...
type ImportTemplateParams struct {
	...
	*/
	Request *models.TemplatesTemplateExportData
...
// WithRequest adds the request to the import template params
func (o *ImportTemplateParams) WithRequest(request *models.TemplatesTemplateExportData) *ImportTemplateParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the import template params
func (o *ImportTemplateParams) SetRequest(request *models.TemplatesTemplateExportData) {
	o.Request = request
}
