...
func (o *DeleteTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 204:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[DELETE /templates/{id}] deleteTemplate", response, response.Code())
	}
}
...
func (o *DeleteTemplateNoContent) Error() string {
	return fmt.Sprintf("[DELETE /templates/{id}][%d] deleteTemplateNoContent", 204)
}
