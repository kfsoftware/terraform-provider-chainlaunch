...
func (o *GetDefaultTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /templates/platforms/{platform}/{nodeType}/default] getDefaultTemplate", response, response.Code())
	}
}
...
func (o *GetDefaultTemplateOK) Error() string {
	...
	return fmt.Sprintf("[GET /templates/platforms/{platform}/{nodeType}/default][%d] getDefaultTemplateOK %s", 200, payload)
}
...
func (o *GetDefaultTemplateOK) GetPayload() *models.TemplatesTemplate {
	return o.Payload
}
