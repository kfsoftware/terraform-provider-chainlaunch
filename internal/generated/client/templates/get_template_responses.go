...
func (o *GetTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /templates/{id}] getTemplate", response, response.Code())
	}
}
...
func (o *GetTemplateOK) Error() string {
	...
	return fmt.Sprintf("[GET /templates/{id}][%d] getTemplateOK %s", 200, payload)
}
...
func (o *GetTemplateOK) GetPayload() *models.TemplatesTemplate {
	return o.Payload
}
