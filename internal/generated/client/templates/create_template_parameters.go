...
type CreateTemplateParams struct {
	...
	*/
	Request *models.TemplatesCreateTemplateRequest
...
func (o *CreateTemplateParams) WithRequest(request *models.TemplatesCreateTemplateRequest) *CreateTemplateParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create template params
func (o *CreateTemplateParams) SetRequest(request *models.TemplatesCreateTemplateRequest) {
	o.Request = request
}
