...
func (o *UpdateUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /users/{id}] updateUser", response, response.Code())
	}
}
...
func (o *UpdateUserOK) Error() string {
	...
	return fmt.Sprintf("[PUT /users/{id}][%d] updateUserOK %s", 200, payload)
}
...
func (o *UpdateUserOK) GetPayload() *models.AuthUserResponse {
	return o.Payload
}
...
func (o *UpdateUserBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{id}][%d] updateUserBadRequest %s", 400, payload)
}
...
func (o *UpdateUserBadRequest) GetPayload() *models.ResponseResponse {
	return o.Payload
}
...
func (o *UpdateUserUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{id}][%d] updateUserUnauthorized %s", 401, payload)
}
...
func (o *UpdateUserUnauthorized) GetPayload() *models.ResponseResponse {
	return o.Payload
}
...
func (o *UpdateUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{id}][%d] updateUserForbidden %s", 403, payload)
}
...
func (o *UpdateUserForbidden) GetPayload() *models.ResponseResponse {
	return o.Payload
}
...
func (o *UpdateUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{id}][%d] updateUserNotFound %s", 404, payload)
}
...
func (o *UpdateUserNotFound) GetPayload() *models.ResponseResponse {
	return o.Payload
}
