...
func (o *DeleteUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /users/{id}] deleteUser", response, response.Code())
	}
}
...
func (o *DeleteUserUnauthorized) Error() string {
	...
	return fmt.Sprintf("[DELETE /users/{id}][%d] deleteUserUnauthorized %s", 401, payload)
}
...
func (o *DeleteUserUnauthorized) GetPayload() *models.ResponseResponse {
	return o.Payload
}
...
func (o *DeleteUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{id}][%d] deleteUserForbidden %s", 403, payload)
}
...
func (o *DeleteUserForbidden) GetPayload() *models.ResponseResponse {
	return o.Payload
}
...
func (o *DeleteUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{id}][%d] deleteUserNotFound %s", 404, payload)
}
...
func (o *DeleteUserNotFound) GetPayload() *models.ResponseResponse {
	return o.Payload
}
