...
type UpdateUserPasswordParams struct {
	...
	*/
	...
	/* Request.
	   ...
	   New password
	*/
	Request *models.AuthChangePasswordRequest
...
func (o *UpdateUserPasswordParams) WithID(id int64) *UpdateUserPasswordParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update user password params
func (o *UpdateUserPasswordParams) SetID(id int64) {
	o.ID = id
}

// WithRequest adds the request to the update user password params
func (o *UpdateUserPasswordParams) WithRequest(request *models.AuthChangePasswordRequest) *UpdateUserPasswordParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the update user password params
func (o *UpdateUserPasswordParams) SetRequest(request *models.AuthChangePasswordRequest) {
	o.Request = request
}
