...
type CreateUserParams struct {
	...
	/* User.
	   ...
	   User to create
	*/
	User *models.AuthCreateUserRequest
...
func (o *CreateUserParams) WithUser(user *models.AuthCreateUserRequest) *CreateUserParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the create user params
func (o *CreateUserParams) SetUser(user *models.AuthCreateUserRequest) {
	o.User = user
}
