...
type UpdateUserParams struct {
	...
	*/
	...
	/* User.
	   ...
	   User updates
	*/
	User *models.AuthUpdateUserRequest
...
func (o *UpdateUserParams) WithUser(user *models.AuthUpdateUserRequest) *UpdateUserParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the update user params
func (o *UpdateUserParams) SetUser(user *models.AuthUpdateUserRequest) {
	o.User = user
}
