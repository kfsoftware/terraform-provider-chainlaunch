...
type CreateProjectParams struct {
	...
	/* Request.
	   ...
	   Project info
	*/
	Request *models.ProjectsCreateProjectRequest
...
func (o *CreateProjectParams) WithRequest(request *models.ProjectsCreateProjectRequest) *CreateProjectParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create project params
func (o *CreateProjectParams) SetRequest(request *models.ProjectsCreateProjectRequest) {
	o.Request = request
}
