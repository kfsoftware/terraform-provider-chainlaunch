...
func (o *ListProjectsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /chaincode-projects] listProjects", response, response.Code())
	}
}
...
type ListProjectsOK struct {
	Payload *models.ProjectsListProjectsResponse
}
...
func (o *ListProjectsOK) Error() string {
	...
	return fmt.Sprintf("[GET /chaincode-projects][%d] listProjectsOK %s", 200, payload)
}
...
func (o *ListProjectsOK) GetPayload() *models.ProjectsListProjectsResponse {
	return o.Payload
}
...
func (o *ListProjectsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ProjectsListProjectsResponse)
...
func (o *ListProjectsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /chaincode-projects][%d] listProjectsInternalServerError %s", 500, payload)
}
...
func (o *ListProjectsInternalServerError) GetPayload() *models.ResponseErrorResponse {
	return o.Payload
}
