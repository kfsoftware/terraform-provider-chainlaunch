...
// WithProjectID adds the projectID to the delete file params
func (o *DeleteFileParams) WithProjectID(projectID int64) *DeleteFileParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the delete file params
func (o *DeleteFileParams) SetProjectID(projectID int64) {
