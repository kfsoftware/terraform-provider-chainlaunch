...
type CreateBackupParams struct {
	...
	*/
	Request *models.HTTPCreateBackupRequest
...
// WithRequest adds the request to the create backup params
func (o *CreateBackupParams) WithRequest(request *models.HTTPCreateBackupRequest) *CreateBackupParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the create backup params
func (o *CreateBackupParams) SetRequest(request *models.HTTPCreateBackupRequest) {
	o.Request = request
}
